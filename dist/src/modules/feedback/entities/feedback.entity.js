...
__decorate([
    ...
    (0, typeorm_1.ManyToOne)((type) => events_entity_1.EventsEntity, (event) => event.feedback),
    __metadata("design:type", events_entity_1.EventsEntity)
], Feedback.prototype, "event", void 0);
__decorate([
    (0, typeorm_1.JoinColumn)({ name: 'userId', referencedColumnName: 'id' }),
    (0, typeorm_1.ManyToOne)((type) => users_entity_1.default, (user) => user.feedback),
...
exports.default = events_entity_1.EventsEntity;
